    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'scroll initial'}}>
      <CDBSidebar textColor="#fff" backgroundColor="#333" maxWidth='250px' minWidth='100px'>
        ...
        <CDBSidebarContent className="sidebar-content">
          <CDBSidebarMenu>
            <NavLink exact to="/dashboard/stats" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="chart-line">Statistique</CDBSidebarMenuItem>
            </NavLink>
            <NavLink exact to="/dashboard/tables" activeClassName="activeClicked">
              <CDBSidebarMenuItem icon="table">Tables</CDBSidebarMenuItem>
            </NavLink>

            <NavLink exact to="/dashboard/revenue" activeClassName="activeClicked">
